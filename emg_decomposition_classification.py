...
if __name__ == "__main__":
    ...
    data_features = ffunctions.default_feature_extraction(data_filtered.copy(), data_labels, label_map, data_fs,
        ...
        all_decomposed_actual_waveform_indices, all_decomposed_muap_firing_table, all_decomposed_residue_waveforms,
                                               verbose=feature_extract_verbose, plot_fig_num=fig_num, plot_mode=feature_extract_plot
    )